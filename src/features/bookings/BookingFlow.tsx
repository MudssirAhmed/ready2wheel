            ...
            {pricing && (
              <div className="bg-blue-600/10 border border-blue-400/20 rounded-xl p-4">
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-white">{pricing.durationValue} {pricing.durationValue === 1 ? pricing.durationType : ({ hourly: 'hours', daily: 'days', weekly: 'weeks', monthly: 'months' }[pricing.durationType] ?? pricing.durationType + 's')}</span>
                </div>
                <div className="flex justify-between text-sm mb-1">
